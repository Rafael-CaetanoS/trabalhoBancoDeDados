...
<html lang="pt-BR">
  ...
  <body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM compra_produtos WHERE idCompra =" .$id ;
            ...
            <div class="formularioDados">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-danger mt-3 mb-2 col-md-12" onclick="location.href='compra_produto.php?'" type="button">Cancelar</button>
                        </div>
                    </div>                
                </form>
            </div>

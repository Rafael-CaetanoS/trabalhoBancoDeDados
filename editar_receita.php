    ...
    <div class="container-fluid" id="editar">
        <div class="formulario">
            <div class="formularioDados">
                <h2 class="titulo">Editar Receita</h2>
                <form class="row g-3" action="CadastroBanco.php?operacao=editar&tabela=receita&id=<?php echo $id; ?>" method="post">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="cpfCliente" name="cpfCliente" value ="<?php print $row->cpfCliente; ?>">
                    </div>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-danger mt-3 mb-2 col-md-12" onclick="location.href='cadastro_receita.php?'" type="button">Cancelar</button>
                        </div>
                    </div>                
                </form>
            </div>

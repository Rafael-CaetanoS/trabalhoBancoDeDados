...
<html lang="pt-BR">
  ...
  <body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM cat_produto WHERE idCat_produto =" .$id ;
    ...
    <div class="container-fluid" id="editar">
        <div class="formulario">
            <div class="formularioDados">
                ...
                <form class="row g-3" action="CadastroBanco.php?operacao=editar&tabela=cat_produto&id=<?php echo $id; ?>" method="post">
                    <div class="col-md-4">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-danger mt-3 mb-2 col-md-12" onclick="location.href='cadastro_categoria.php?'" type="button">Cancelar</button>
                        </div>
                    </div>                
                </form>
            </div>

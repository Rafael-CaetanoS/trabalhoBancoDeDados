    ...
    <main>
        <div class="formulario">
            <div class="formularioDados">
                <h2 class="titulo">Cadastro de Compra de Fornecedor</h2>
                <form class="row g-3">
                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">Data da Compra</label>
                    ...
                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">Quantidade</label>

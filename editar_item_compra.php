...
<html lang="pt-BR">
  ...
  <body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM item_compra WHERE idItem =" .$id ;
            ...
            <div class="formularioDados">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-danger mt-3 mb-2 col-md-12" onclick="location.href='item_compra.php?'" type="button">Cancelar</button>
                        </div>
                    </div>                
                </form>
            </div>

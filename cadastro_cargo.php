...
<html lang="pt-BR">
  ...
  <body>
            ...
            <tbody class="table-group-divider">
              ...
              if ($result->num_rows > 0) {
                foreach ($result as $row) {
                  ...
                  echo "<td>
                  <button type='button' class='btn btn-primary' onclick=\"location.href='editar_cargo.php?id=".$row['idCargo']."'\" id='editar' >Editar</button>
    ...
    <div class="container-fluid" style="display:none"  id="editar">
        <div class="formulario">
            <div class="formularioDados">

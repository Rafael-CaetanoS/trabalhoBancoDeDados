        ...
        <div class="formulario">
            <div class="formularioDados">
                ...
                <form class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">RG</label>
                        <input type="number" class="form-control " id="" value="" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="email" class="form-control " id="" value="" required>
                    </div>

                    <h2 class="titulo">Endereço</h2>
                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">CEP</label>
                        <input type="text" class="form-control " id="" value="" required>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">Rua</label>
                        <input type="text" class="form-control " id="" value="" required>
                    </div>

                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">Número</label>
                        <input type="text" class="form-control " id="" value="" required>
                    </div>

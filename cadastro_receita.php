        ...
        <main>
            <div class="formulario">
                <div class="formularioDados">
                    <h2 class="titulo">Cadastro da Receita do Cliente</h2>
                    <form class="row g-3">
                        <div class="col-md-4">
                            <label for="validationServer01" class="form-label">Nome do Medico</label>
                            <input type="text" class="form-control " id="" value="" required>
                        </div>

                        <div class="col-md-4">
                            <label for="validationServer02" class="form-label">Remédio</label>
                            <input type="text" class="form-control " id="" value="" required>
                        </div>
    
                        <div class="col-md-4">
                            <label for="validationServer02" class="form-label">Descrição</label>
                            <input type="text" class="form-control " id="" value="" required>
                        </div>
    
                        <div class="col-md-4">
                            <label for="validationServer02" class="form-label">Dosagem</label>
                            <input type="text" class="form-control " id="" value="" required>
                        </div>
                        
                        <div class="col-12">
                            <button class="btn btn btn-primary botao" type="submit">Cadastrar</button>
                        </div>
                </form>
            </div>
        </div>

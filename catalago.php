    ...
    <main>
        ...
        <div class="card-container" style="display: flex; justify-content: space-around;">
            <div class="card" style="width: 18rem;">
                <img src="Image/3.jpg" class="card-img-top" alt="Imagem do card">
                <div class="card-body">
                  <h5 class="card-title">Medicamentos Prescritos</h5>
                  <p class="card-text">Medicamentos somente prescritos.</p>
                </div>
              </div>

            <div class="card" style="width: 18rem;">
              <img src="Image/4.jpeg" class="card-img-top" alt="Imagem do card">
              <div class="card-body">
                <h5 class="card-title">Medicamentos Venda Livre</h5>
                <p class="card-text">Medicamentos venda livre.</p>
              </div>
            </div>

            <div class="card" style="width: 18rem;">
                <img src="Image/5.jpg" class="card-img-top" alt="Imagem do card">
                <div class="card-body">
                  <h5 class="card-title">Vitaminas e Suplementos </h5>
                  <p class="card-text">Vitaminas e suplementos...</p>
                </div>
              </div>

            <div class="card" style="width: 18rem;">
                <img src="Image/6.jpg" class="card-img-top" alt="Imagem do card"  >
                <div class="card-body">
                  <h5 class="card-title">Cuidados com a Pele</h5>
                  <p class="card-text">Cremes hidratantes, protetor solar...</p>
                </div>
              </div>

              <div class="card" style="width: 18rem;">
                <img src="Image/7.jpg" class="card-img-top" alt="Imagem do card">
                <div class="card-body">
                  <h5 class="card-title">Higiene Pessoal</h5>
                  <p class="card-text">Pasta de dente, escova de dentes...</p>
                </div>
              </div>
          </div>
          <br>
          ...
          <div class="card-container" style="display: flex; justify-content: space-around;">
            <div class="card" style="width: 18rem;">
                <img src="Image/8.png" class="card-img-top" alt="Imagem do card">
                <div class="card-body">
                  <h5 class="card-title">Cuidados com os Cabelos</h5>
                  <p class="card-text">Tinturas, acessórios para cabelo...</p>
                </div>
              </div>

            <div class="card" style="width: 18rem;">
              <img src="Image/9.jpg" class="card-img-top" alt="Imagem do card">
              <div class="card-body">
                <h5 class="card-title">Cuidados infantis</h5>
                <p class="card-text">Fraldas, pomadas para assaduras, mamadeiras...</p>
              </div>
            </div>

            <div class="card" style="width: 18rem;">
                <img src="Image/10.png" class="card-img-top" alt="Imagem do card">
                <div class="card-body">
                  <h5 class="card-title">Primeiros Socorros</h5>
                  <p class="card-text">Curativos, bandagens, álcool, algodão...</p>
                </div>
              </div>

            <div class="card" style="width: 18rem;">
                <img src="Image/11.jpeg" class="card-img-top" alt="Imagem do card">
                <div class="card-body">
                  <h5 class="card-title">Resfriado e Gripe</h5>
                  <p class="card-text">Descongestionantes, xaropes para tosse...</p>
                </div>
              </div>

              <div class="card" style="width: 18rem;">
                <img src="Image/12.jpg" class="card-img-top" alt="Imagem do card">
                <div class="card-body">
                  <h5 class="card-title">Alívio da dor muscular</h5>
                  <p class="card-text">Pomadas analgésicas, compressas térmicas...</p>
                </div>
              </div>
          </div>

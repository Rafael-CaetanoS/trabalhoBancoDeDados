...
<html lang="pt-BR">
  ...
  <body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM tipo_entrega WHERE idTipo_entrega =" .$id ;
    ...
    <div class="container-fluid" id="editar">
        <div class="formulario">
            <div class="formularioDados">
                <h2 class="titulo">Editar Tipo de Entrega</h2>
                <form class="row g-3" action="CadastroBanco.php?operacao=editar&tabela=tipo_entrega&id=<?php echo $id; ?>" method="post">
                    <div class="col-md-4">

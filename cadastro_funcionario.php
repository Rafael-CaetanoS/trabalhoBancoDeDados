    ...
    <main>
        <div class="formulario">
            <div class="formularioDados">
                <h2 class="titulo">Dados do Funcionário</h2>
                <form class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">Cargo</label>
                        <select name="cars" id="cars" form="carform" class="form-select">
                    ...
                    <div class="col-md-4">
                        <label for="validationServer02" class="form-label">Salário</label>
                        <input type="number" class="form-control " id="" value="" required>
                    </div>

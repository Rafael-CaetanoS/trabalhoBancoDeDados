      ...
      <div class="container ">
        <div class="fundoTabela">
            ...
            <tbody class="table-group-divider">
              ...
              if ($result->num_rows > 0) {
                foreach ($result as $row) {
                  ...
                  echo "<td>
                    <button type='button' class='btn btn-primary' onclick=\"location.href='editar_funcionario.php?id=".$row['cpf']."'\" id='editar'>Editar</button>
          ...
          <div class="d-flex justify-content-center align-items-center">
            <button type="button" class="btn btn-primary mt-1 mb-2 col-md-6" id="cadastrar">Cadastrar Funcionário</button>
          </div>  
        </div>
      </div>
    </div>

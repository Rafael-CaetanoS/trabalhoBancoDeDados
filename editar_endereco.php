    ...
    <div class="container-fluid" id="editar">
        <div class="formulario">
            <div class="formularioDados">
                <h2 class="titulo">Editar Endereco</h2>
                <form class="row g-3" action="CadastroBanco.php?operacao=editar&tabela=endereco&id=<?php echo $id; ?>" method="post">
                    <div class="col-md-4">
                        <label for="rua" class="form-label">Rua</label>
                        <input type="text" class="form-control" id="rua" name="rua" value ="<?php print $row->rua; ?>">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="numero" name="numero" value ="<?php print $row->numero; ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="cpfCliente" class="form-label">ID Cliente</label>
                        <input type="number" class="form-control" id="cpfCliente" name="cpfCliente" value ="<?php print $row->cpfCliente; ?>">
                    </div>

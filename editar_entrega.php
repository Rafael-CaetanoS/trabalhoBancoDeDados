...
<html lang="pt-BR">
  ...
  <body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM entrega WHERE idEntrega =" .$id ;
    ...
    <div class="container-fluid" id="editar">
        <div class="formulario">
            <div class="formularioDados">
                <h2 class="titulo">Editar Entrega</h2>
                <form class="row g-3" action="CadastroBanco.php?operacao=editar&tabela=entrega&id=<?php echo $id; ?>" method="post">
                    <div class="col-md-4">
                        <label for="idVenda" class="form-label">ID Venda</label>
                        <input type="number" class="form-control" id="idVenda" name="idVenda" value ="<?php print $row->idVenda; ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="idTipo_Entrega" class="form-label">ID Tipo de Entrega</label>
                        <input type="number" class="form-control" id="idTipo_Entrega" name="idTipo_Entrega" value ="<?php print $row->idTipo_Entrega; ?>">
                    </div>

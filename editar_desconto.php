...
<html lang="pt-BR">
  ...
  <body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM desconto WHERE idDesconto =" .$id ;
            ...
            <div class="formularioDados">
                ...
                <form class="row g-3" action="CadastroBanco.php?operacao=editar&tabela=desconto&id=<?php echo $id; ?>" method="post">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-danger mt-3 mb-2 col-md-12" onclick="location.href='desconto.php?'" type="button">Cancelar</button>
                        </div>
                    </div>                
                </form>
            </div>
